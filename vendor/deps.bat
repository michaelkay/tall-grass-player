cd files/
del /q *.zip
powershell.exe -Command "& {[Net.ServicePointManager]::SecurityProtocol = \"tls12, tls11, tls\"; (new-object System.Net.WebClient).DownloadFile('https://github.com/slimphp/Slim/archive/2.6.3.zip','2.6.3.zip'); }"
...
powershell.exe -Command "& {[Net.ServicePointManager]::SecurityProtocol = \"tls12, tls11, tls\"; (new-object System.Net.WebClient).DownloadFile('https://github.com/twbs/ratchet/releases/download/v2.0.2/ratchet-2.0.2-dist.zip','ratchet-2.0.2-dist.zip'); }"
...
powershell.exe -Command "& {[Net.ServicePointManager]::SecurityProtocol = \"tls12, tls11, tls\"; (new-object System.Net.WebClient).DownloadFile('https://github.com/blueimp/JavaScript-Templates/archive/v3.11.0.zip','v3.11.0.zip'); }"
...
powershell.exe -Command "& {[Net.ServicePointManager]::SecurityProtocol = \"tls12, tls11, tls\"; (new-object System.Net.WebClient).DownloadFile('https://github.com/RubaXa/Sortable/archive/1.4.0.zip','1.4.0.zip'); }"
...
powershell.exe -Command "& {[Net.ServicePointManager]::SecurityProtocol = \"tls12, tls11, tls\"; (new-object System.Net.WebClient).DownloadFile('https://github.com/michaelkay/cookies.js/archive/0.1.zip','0.1.zip'); }"
